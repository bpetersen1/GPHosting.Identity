...
- **Modern OAuth standards** — Pushed Authorization Requests (RFC 9126), DPoP (RFC 9449), Rich
  Authorization Requests (RFC 9396), JARM, and a composing FAPI 2.0 profile flag are all fully
  enforced end-to-end — protocol features IdentityServer4 never shipped. See
  [PAR & DPoP](/docs/protocols/par-and-dpop), [RAR](/docs/protocols/rar),
  [JARM](/docs/protocols/jarm), and [FAPI 2.0](/docs/protocols/fapi2).

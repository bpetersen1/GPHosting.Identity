...
namespace PostgreSQL.Migrations.ConfigurationDb
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowedAuthorizationDetailsTypes = table.Column<string>(type: "text", nullable: true),
                    RequireFapi2 = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {

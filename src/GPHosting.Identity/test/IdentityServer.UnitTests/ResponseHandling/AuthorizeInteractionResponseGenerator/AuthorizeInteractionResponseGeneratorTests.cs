...
namespace IdentityServer.UnitTests.ResponseHandling.AuthorizeInteractionResponseGenerator
{
    public class AuthorizeInteractionResponseGeneratorTests
    {
        ...
        private GPHosting.Identity.ResponseHandling.AuthorizeInteractionResponseGenerator _subject;
        ...
        {
            _subject = new GPHosting.Identity.ResponseHandling.AuthorizeInteractionResponseGenerator(
                _clock,
                TestLogger.Create<GPHosting.Identity.ResponseHandling.AuthorizeInteractionResponseGenerator>(),
                _mockConsentService,

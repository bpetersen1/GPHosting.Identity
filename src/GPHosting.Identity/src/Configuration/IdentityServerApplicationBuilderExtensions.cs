...
public static class IdentityServerApplicationBuilderExtensions
{
    ...
    internal static void Validate(this IApplicationBuilder app)
    {
        ...
        var logger = loggerFactory.CreateLogger("GPHosting.Identity.Startup");
        logger.LogInformation("Starting GPHosting.Identity version {version}", typeof(GPHosting.Identity.Hosting.IdentityServerMiddleware).Assembly.GetCustomAttribute<AssemblyInformationalVersionAttribute>().InformationalVersion);

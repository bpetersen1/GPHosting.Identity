...
using GPHosting.Identity.Configuration.DependencyInjection;
using GPHosting.Identity.Endpoints;
...
using GPHosting.Identity.Hosting.FederatedSignOut;
using GPHosting.Identity.Services.Default;
...
public static class IdentityServerBuilderExtensionsCore
{
        ...
        where T : class, IEndpointHandler
    {
        ...
        builder.Services.AddSingleton(new GPHosting.Identity.Hosting.Endpoint(name, path, typeof(T)));
    ...
    public static IIdentityServerBuilder AddPluggableServices(this IIdentityServerBuilder builder)
    {
        ...
        builder.Services.AddTransient<IPushedAuthorizationRequestStore, InMemoryPushedAuthorizationRequestStore>();
    ...
    public static IIdentityServerBuilder AddValidators(this IIdentityServerBuilder builder)
    {
        ...
        builder.Services.AddTransient<IDPoPProofValidator, DefaultDPoPProofValidator>();

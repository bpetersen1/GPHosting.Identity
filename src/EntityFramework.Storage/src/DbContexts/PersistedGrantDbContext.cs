...
using GPHosting.Identity.EntityFramework.Extensions;
using GPHosting.Identity.EntityFramework.Interfaces;
using GPHosting.Identity.EntityFramework.Options;
using Microsoft.EntityFrameworkCore;

namespace GPHosting.Identity.EntityFramework.DbContexts;
/// <summary>
/// DbContext for the IdentityServer operational data.
/// </summary>
/// <seealso cref="Microsoft.EntityFrameworkCore.DbContext" />
/// <seealso cref="GPHosting.Identity.EntityFramework.Interfaces.IPersistedGrantDbContext" />

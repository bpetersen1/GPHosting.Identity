...
- **Pushed Authorization Requests (RFC 9126), DPoP (RFC 9449), Rich Authorization Requests
  (RFC 9396), and JARM** — modern, fully-enforced OAuth extensions IdentityServer4 never shipped.
  See [PAR & DPoP](/docs/protocols/par-and-dpop), [RAR](/docs/protocols/rar), and

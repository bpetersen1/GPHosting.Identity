...
Please start a discussion on the [issue tracker](https://github.com/bpetersen1/GPHosting.Identity/issues).
...
1. Did you read the [README](https://github.com/bpetersen1/GPHosting.Identity#readme)?
2. Did you include the snippet of broken code in the issue?
3. What are the *EXACT* steps to reproduce this problem?
4. Did you enable logging (see the Observability section of the README)?

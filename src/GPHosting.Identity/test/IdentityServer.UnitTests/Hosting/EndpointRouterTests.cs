...
namespace IdentityServer.UnitTests.Hosting
{
    ...
    {
        private Dictionary<string, GPHosting.Identity.Hosting.Endpoint> _pathMap;
        private List<GPHosting.Identity.Hosting.Endpoint> _endpoints;
        private IdentityServerOptions _options;
        private EndpointRouter _subject;

        public EndpointRouterTests()
        {
            _pathMap = new Dictionary<string, GPHosting.Identity.Hosting.Endpoint>();
            _endpoints = new List<GPHosting.Identity.Hosting.Endpoint>();
        ...
        {
            Action a = () => new GPHosting.Identity.Hosting.Endpoint("ep1", "ep1", typeof(MyEndpointHandler));
        ...
        {
            _endpoints.Add(new GPHosting.Identity.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new GPHosting.Identity.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new GPHosting.Identity.Hosting.Endpoint("ep1", "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new GPHosting.Identity.Hosting.Endpoint("ep1", "/ep1", typeof(MyOtherEndpointHandler)));
        ...
        {
            _endpoints.Add(new GPHosting.Identity.Hosting.Endpoint(EndpointNames.Authorize, "/ep1", typeof(MyEndpointHandler)));
            _endpoints.Add(new GPHosting.Identity.Hosting.Endpoint("ep2", "/ep2", typeof(MyOtherEndpointHandler)));

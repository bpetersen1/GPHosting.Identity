...
namespace IdentityServer.UnitTests.Services.Default
{
    public class DefaultRefreshTokenServiceTests
    {
        ...
        public async Task CreateRefreshToken_token_exists_in_store()
        {
            ...
            var accessToken = new Token { Claims = new List<Claim> { new Claim("sub", "123") } };
        ...
        public async Task CreateRefreshToken_should_match_absolute_lifetime()
        {
            ...
            var handle = await _subject.CreateRefreshTokenAsync(_user, new Token { Claims = new List<Claim> { new Claim("sub", "123") } }, client);
